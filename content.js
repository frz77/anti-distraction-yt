const quotes = [
    "Stay Focused.", "Deep work only.", "Don't consume, create.", "Is this helping your goal?",
    "Silence the noise.", "Distraction is a choice.", "Your time is finite.", "Focus is a superpower.",
    "Master your attention.", "Why are you here?", "Discipline equals freedom.", "Action > Browsing.",
    "Сфокусируйся на главном.", "Твое время — твой актив.", "Не потребляй, а создавай.",
    "Дисциплина — это свобода.", "Внимание — новая валюта.", "Ты здесь за ответом или за дофамином?",
    "Сломай алгоритм.", "Будь умнее системы.", "Концентрация — твой щит."
];
...
function applyUltraZen() {
    ...
    if (document.title !== "AntiDistraction YT") document.title = "AntiDistraction YT";

    const isMainPage = window.location.pathname === '/' && !window.location.search.includes('search_query');
...
titleObserver.observe(document.documentElement, { subtree: true, characterData: true, childList: true });
